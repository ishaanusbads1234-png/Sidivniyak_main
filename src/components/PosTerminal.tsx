...
import { Plus, Trash, Check, Loader2, Printer, Camera, QrCode, Search, Smartphone } from "lucide-react";
      ...
      {activeInvoice && (
        ...
        >
          ...
          <div className="flex gap-2">
            <button
              onClick={() => {
                alert("Triggering active device hardware system print spooler... Memo printed successfully");
              }}
